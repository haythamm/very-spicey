...
#           [start, stop, closest_app] DUMMY TIMES
blackbody_1 = [570883200, 570883290, 570883245]
blackbody_2 = [571222000, 571222090, 571222045]
cities = [[570883306.09, 570883681.47, 570883500], [571222176.41, 571222552.84, 571222300]]
...
#list of commands relevant to Science Mode
